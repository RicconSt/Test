...
#    frame=cv2.flip(frame,1)  #mirror the image
    ...
    faces= face_cascade.detectMultiScale(gray,1.1,6)  #detecting the face 
    for x,y,w,h in faces:
        #sending coordinates to Arduino
        string='X{0:d}Y{1:d}'.format((320-x-w//2),(240-y-h//2))
        print(string)
    ...
    #plot the white squared region in the center of the screen
